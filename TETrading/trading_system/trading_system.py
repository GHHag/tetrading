...
class TradingSystem:
    ...
    def __call__(
        ...
        write_signals_to_file_path=None, insert_data_to_db_bool=False, signal_handler_db_insert_funcs=None,
        single_symbol_pos_list_db_insert_func=None, full_pos_list_db_insert_func=None, 
