...
from TETrading.metrics.metrics_summary_plot import strategy_metrics_summary_plot
...
class Metrics:
    ...
    def _calculate_max_drawdown(self):
        ...
        for index, ret in enumerate(self.__equity_list):
            if ret > peak_value:
                peak_value = ret
    ...
    def _calculate_expectancy(self):
        ...
        return ((self.__pct_wins / 100) * float(self.__mean_positive_pos)) - \
               ((self.__pct_losses / 100) * float(self.__mean_negative_pos))
    ...
    def _calculate_sharpe_ratio(self, risk_free_rate=Decimal(0.05)):
        """
    ...
    def _calculate_avg_annual_profit(self, yearly_periods=251):
        ...
        try:
            ...
            print('ZeroDivisionError, calculate_annual_avg_profit')
    ...
    def plot_performance_summary(self, asset_returns, plot_fig=False, save_fig_to_path=None):
        """
        ...
        ----------
        :param asset_returns:
            'List' : A collection of returns.
        :param plot_fig:
            Keyword arg 'Boolean' : True/False decides whether the
        ...
        strategy_metrics_summary_plot(self.__market_to_market_returns_list, self.__equity_list,
                                      asset_returns, self.__mae_list, self.__mfe_list,
