...
class PositionManager:
    ...
    start_capital : 'int/float'
        The initial amount of capital to purchase assets for.
    ...
    def __init__(self, symbol, num_testing_periods, start_capital, capital_fraction, asset_price_series=None):
    ...
    def generate_positions(self, trade_logic, *args, **kwargs):
        ...
        self.__generated_positions = trade_logic(*args, capital=self.__safe_f_capital,
                                                 **kwargs)
    ...
    def _create_metrics(self):
        ...
        if not self.__generated_positions:
            ...
            self.__metrics = Metrics(self.__symbol, self.__generated_positions, self.__start_capital,
                                     self.__num_testing_periods)
    ...
    def summarize_performance(self, plot_fig=False, save_fig_to_path=None):
        ...
        ----------
        :param plot_fig:
            Keyword arg 'Boolean' : True/False decides if the figure
        ...
        if len(self.__metrics.positions) < 1:
            ...
            if plot_fig or save_fig_to_path:
                self.__metrics.plot_performance_summary(self.__asset_price_series,
